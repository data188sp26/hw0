...
def add(x: Union[float, np.ndarray], y: Union[float, np.ndarray]) -> Union[float, np.ndarray]:
...
def softmax_loss(Z: np.ndarray, y: np.ndarray) -> np.ndarray:
...
def loss_err(h: np.ndarray, y: np.ndarray) -> tuple[np.ndarray, np.ndarray]:
